...
TypeZen 是一款专为微信公众号设计的「Markdown 转微信排版」辅助工具。写好 Markdown 文本后，可以使用 AI 一键优化排版结构，再套用 84 套不同风格的精美模板，并直接复制粘贴到微信公众平台后台。
...
- **丰富的主题模板**：内置 **84 套**精美模板，覆盖 7 大风格分类，并支持自定义主题色。
