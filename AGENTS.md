...
TypeZen 是一款专为微信公众号设计的「Markdown 转微信排版」辅助工具。用户编写 Markdown 文本后，可以使用 AI 一键优化排版结构，再套用 84 套不同风格的精美模板，可直接复制粘贴到微信公众平台后台。
...
- 已完成模板扩展到 84 套，当前分类为新粗野、极简、商务、文艺、国风、科技、节庆 7 类
